...
NTUPLEDIR   = "/nfs/dust/cms/group/cms-llp/v0_pfXTag_calo/"
OUTPUTDIR   = "$CMSSW_BASE/src/Analyzer/LLP2018/macro/Efficiency/v0_pfXTag_calo/"
...
for a in fom:
    ...
    calc_punzi_FOM_vs_ctau(
        ...
        header = "Puppi",#str(n_matches)+" VBF jets gen matched",
        mass_point=40,#15,#50
...
for a in fom:
    calc_punzi_FOM_vs_ctau(
        ...
        [
            "Pre-selections",
            "+ 2 Puppi jets nTracKConstituents<10",
