...
samples = {
    ...
    #TTbar
    'TTbar' : {
        'files' : ['TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8-v1','TTToHadronic_TuneCP5_13TeV-powheg-pythia8-v1','TTTo2L2Nu_TuneCP5_13TeV-powheg-pythia8-v1'],
        'fillcolor' : 798,
        'fillstyle' : 1001,
        'linecolor' : 798,
        'linewidth' : 2,
    ...
    #WJets
    'WJetsToLNu' : { 
        'files' : ['WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8-v2'],
        'fillcolor' : 881,
        'fillstyle' : 1001,
        'linecolor' : 881,
        'linewidth' : 2,
