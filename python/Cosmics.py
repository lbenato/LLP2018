...
###process.ntuple = cms.EDAnalyzer('Ntuplizer',
    ...
    chsJetSet = cms.PSet(
        ...
        ebRecHits = cms.InputTag("EcalRecHitsEB", "","RECO"),
        eeRecHits  = cms.InputTag("EcalRecHitsEE", "","RECO"),
        esRecHits = cms.InputTag("EcalRecHitsES", "","RECO"),
...
outFile = open("tmpConfig_Cosmics.py","w")
