...
process.pfImpactParameterTagInfos.maximumChiSquared = cms.double(5.0)#99999.9)
process.pfImpactParameterTagInfos.maximumLongitudinalImpactParameter = cms.double(17.0)#99999.9)
process.pfImpactParameterTagInfos.maximumTransverseImpactParameter = cms.double(0.2)#99999.9)
process.pfImpactParameterTagInfos.minimumNumberOfHits = cms.int32(8)#0)
process.pfImpactParameterTagInfos.minimumNumberOfPixelHits = cms.int32(2)#1)#at least 1, otherwise tracking issues!13Dec
