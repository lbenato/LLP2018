...
if options.lists == "v0_pfXTag_calo":
    ...
    from Analyzer.LLP2018.crab_requests_lists_v0_pfXTag_calo import *
    LUMI = 35867#36814# in pb-1 Full 2016 with normtag
elif options.lists == "v9_L1trigger":
    from Analyzer.LLP2018.crab_requests_lists_v9_L1trigger import *
    LUMI = 35867#36814# in pb-1 Full 2016 with normtag
elif options.lists == "v1_pfXTag_short":
...
######################This blocks naf machines
    ...
    if "VBFH_MH-125_201" in options.groupofsamples:
        ...
        #    os.system('hadd -k -f '+DEST+name+'.root '+fold+'/*/*/*/output_*7.root')# + ' ' +name+'/*/*/*/*_1.root')
        os.system('hadd -k -f '+DEST+name+'.root ' + fold + "/*/*/*/*.root")#timestamp for calo_signal!
    #os.system('hadd -k -f -O '+DEST+name+'.root ' + fold + "/*/*/*/*.root")# for TTbar with failures
pass
