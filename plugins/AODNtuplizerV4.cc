// -*- C++ -*-
//
// Package:    Analyzer/AODNtuplizerV4
// Class:      AODNtuplizerV4
// 
/**\class AODNtuplizerV4 AODNtuplizerV4.cc Analyzer/LLP2018/plugins/AODNtuplizerV4.cc
...
class AODNtuplizerV4 : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit AODNtuplizerV4(const edm::ParameterSet&);
      ~AODNtuplizerV4();
...
//
AODNtuplizerV4::AODNtuplizerV4(const edm::ParameterSet& iConfig):
...
void
AODNtuplizerV4::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  //if(isVerbose) std::cout << " Starting analyze..... " << std::endl;
    ...
    */
    ...
    //Here sort in pt
    std::sort(PFCandidateVect.begin(), PFCandidateVect.end(), AODNtuplizerV4::pt_sorter);
...
bool AODNtuplizerV4::pt_sorter(const pat::PackedCandidate& x, const pat::PackedCandidate& y) { return x.pt() > y.pt(); }

// ------------ method called once each job just after ending the event loop  ------------
void 
AODNtuplizerV4::endJob() 
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
AODNtuplizerV4::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(AODNtuplizerV4);
