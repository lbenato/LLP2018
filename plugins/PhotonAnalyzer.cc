...
PhotonAnalyzer::PhotonAnalyzer(edm::ParameterSet& PSet, edm::ConsumesCollector&& CColl):
    ...
    PhoLooseId(PSet.getParameter<std::string>("phoLooseId")),
    PhoMediumId(PSet.getParameter<std::string>("phoMediumId")),
    PhoTightId(PSet.getParameter<std::string>("phoTightId")),
    PhoMVANonTrigMediumId(PSet.getParameter<std::string>("phoMVANonTrigMediumId")),
...
std::vector<pat::Photon> PhotonAnalyzer::FillPhotonVector(const edm::Event& iEvent) {
    ...
    //iEvent.getByToken(PhoLooseId, LooseIdDecisions);
    //iEvent.getByToken(PhoMediumId, MediumIdDecisions);
    //iEvent.getByToken(PhoTightId, TightIdDecisions);
    //iEvent.getByToken(PhoMVANonTrigMediumId, MVANonTrigMediumIdDecisions);
  ...
  pat::PhotonRef phRef(PhoCollection,phIdx);
        ...
        bool isPassLoose = ph.photonID(PhoLooseId);
        bool isPassMedium = ph.photonID(PhoMediumId);
        bool isPassTight = ph.photonID(PhoTightId);
        bool isPassMVANonTrigMedium = ph.photonID(PhoMVANonTrigMediumId);
