...
class Ntuplizer : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
  ...
  //CaloJetAnalyzer* theCaloJetAnalyzer;
    ...
    PileupAnalyzer* thePileupAnalyzer_HLT_Mu9_IP6_UL;
    PileupAnalyzer* thePileupAnalyzer_HLT_Mu9_IP6_v7;
  ...
  //long int number_of_b_matched_to_CaloJets, number_of_b_matched_to_CaloJetsWithGenJets;
    ...
    float PUWeight_HLT_Mu9_IP6_UL, PUWeightUp_HLT_Mu9_IP6_UL, PUWeightDown_HLT_Mu9_IP6_UL;
    float PUWeight_HLT_Mu9_IP6_v7, PUWeightUp_HLT_Mu9_IP6_v7, PUWeightDown_HLT_Mu9_IP6_v7;
