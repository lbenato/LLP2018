// -*- C++ -*-
//
// Package:    Analyzer/LLP2018Reco
// Class:      LLP2018Reco
//
/**\class LLP2018Reco LLP2018Reco.cc Analyzer/LLP2018Reco/plugins/LLP2018Reco.cc
...
class LLP2018Reco : public edm::one::EDAnalyzer<edm::one::SharedResources>  {
   public:
      explicit LLP2018Reco(const edm::ParameterSet&);
      ~LLP2018Reco();
...
//
LLP2018Reco::LLP2018Reco(const edm::ParameterSet& iConfig)
 :
...
void
LLP2018Reco::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   using namespace edm;
   nElectrons = 0;
   nRecoElectrons = 0;
...
void
LLP2018Reco::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
