...
void ObjectsFormat::FillJetType(JetType& I, const pat::Jet* R, bool isMC) {
  ...
  //  }
    ...
    I.PUId           = -1;//R->hasUserInt("pileupJetId:fullId") ? R->userInt("pileupJetId:fullId") : -1;
    I.PUIdLoose      = false;//bool(R->userInt("pileupJetId:fullId") & (1 << 2))? true : false;
    I.PUIdMedium     = false;//bool(R->userInt("pileupJetId:fullId") & (1 << 1))? true : false;
    I.PUIdTight      = false;//bool(R->userInt("pileupJetId:fullId") & (1 << 0))? true : false;
    I.PUDiscriminant = -2.;//R->hasUserFloat("pileupJetId:fullDiscriminant") ? R->userFloat("pileupJetId:fullDiscriminant") : -2.;
    //I.isMatched   = false;
