...
class ElectronAnalyzer {
    ...
    private:
        ...
        std::string EleVetoId;
        std::string EleLooseId;
        std::string EleMediumId;
        std::string EleTightId;
        std::string EleHEEPId;
        std::string EleMVANonTrigMediumId;
        std::string EleMVANonTrigTightId;
        std::string EleMVATrigMediumId;
        std::string EleMVATrigTightId;
