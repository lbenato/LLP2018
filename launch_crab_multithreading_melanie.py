...
config.JobType.inputFiles = ['data', 'data_gen']
...
if __name__ == '__main__':
    ...
    if options.lists == "v7_calo":
        ...
        pset = "Ntuplizer2018.py"
        folder = "v10_bPhaseSpace_Xtagger"
        outLFNDirBase = "/store/user/meich/"+folder
        workarea = "/nfs/dust/cms/user/eichm/" + folder
        isCalo=False
        isVBF = True
        isggH = False
    elif options.lists == "v0_gen_production_short":
        from Analyzer.LLP2018.crab_requests_lists_v10 import *
        pset = "GenNtuplizer.py"
        folder = "v0_gen_production_short"
        outLFNDirBase = "/store/user/meich/"+folder
        workarea = "/nfs/dust/cms/user/eichm/" + folder
        isCalo=False
        isVBF = True
